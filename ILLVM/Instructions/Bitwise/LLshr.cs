...
namespace ILLVM.Instructions.Bitwise {
    ...
    /// </summary>
    public class LLshr : ILBaseInstr {
        ...
        public LLshr(LValueRef result, LValueRef op1, LValueRef op2) {
            ...
            if (result.Type.IsFloatingPoint()) {
                throw new Exception("Floating point types are not allowed for lshr.");
            }
        ...
        public LLshr(LVectorRef result, LVectorRef op1, LVectorRef op2) {
