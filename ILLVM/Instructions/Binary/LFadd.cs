...
namespace ILLVM.Instructions.Binary {
    ...
    /// </summary>
    public class LFadd : ILBaseInstr {
        ...
        public LFadd(LValueRef result, LValueRef op1, LValueRef op2) {
            ...
            if (!result.Type.IsFloatingPoint()) {
                throw new Exception("Only floating point types are allowed for fadd.");
            }
