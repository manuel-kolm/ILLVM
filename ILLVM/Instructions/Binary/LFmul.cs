...
namespace ILLVM.Instructions.Binary {
    ...
    /// </summary>
    public class LFmul : ILBaseInstr {
        ...
        public LFmul(LValueRef result, LValueRef op1, LValueRef op2) {
            ...
            if (!result.Type.IsFloatingPoint()) {
                throw new Exception("Only floating point types are allowed for fmul.");
            }
        ...
        public string ParseInstruction() {
            ...
            sb.Append(LRefHelper.GetIdentifierOf(Result)).Append(" = ").Append(LKeywords.Fmul).Append(" ");
